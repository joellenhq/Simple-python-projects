...
<details>
  ...
  <ol>
    <li>
      <a href="#arithmetic-arranger">Arithmetic arranger</a>
    </li>
    <li>
      <a href="#time-calculator">Time calculator</a>
    </li>
    <li><a href="#budget-app">Budget app</a></li>
    <li><a href="#polygon-area-calculator">Polygon area calculator</a></li>
